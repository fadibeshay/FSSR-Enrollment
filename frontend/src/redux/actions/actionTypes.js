...
// Department
export const DEPARTMENT_LOADING = "SUBJECT_LOADING";
export const DEPARTMENTS_LOADED = "SUBJECTS_LOADED";
export const DEPARTMENT_LOADED = "SUBJECT_LOADED";
export const DEPARTMENT_CREATED = "SUBJECT_CREATED";
export const DEPARTMENT_UPDATED = "SUBJECT_UPDATED";
export const DEPARTMENT_DELETED = "SUBJECT_DELETED";
export const DEPARTMENT_FAIL = "SUBJECT_FAIL";
