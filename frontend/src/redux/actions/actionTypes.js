...
export const YEAR_SEMESTERS_LOADING = "YEAR_SEMESTERS_LOADING";
export const YEAR_SEMESTERS_LOADED = "YEAR_SEMESTERS_LOADED";

// Semester
export const SEMESTER_LOADING = "SEMESTER_LOADING";
export const SEMESTERS_LOADED = "SEMESTERS_LOADED";
...
export const SEMESTERS_COURSES_LOADING = "SEMESTERS_COURSES_LOADING";
export const SEMESTERS_COURSES_LOADED = "SEMESTERS_COURSES_LOADED";
